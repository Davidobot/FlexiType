...
class JoyCon:
    ...
    def set_home_led_on(self):
        if self.is_left():
            print("Left joycon does not have home LED")
            return
        self._write_output_report(
            b'\x01', b'\x38',
            b'\x1F\xF0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff')
    ...
    def set_home_led_off(self):
        ...
        self._write_output_report(
            b'\x01', b'\x38',
            b'\x10\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff')
